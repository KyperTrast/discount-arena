...
constexpr const char *GAMEVERSION = "dcarena";
...
void arena_respawn(edict_t* ent);    // Kyper - Discount Arena - alternate respawn for players still alive
...
void ArenaChaseNext(edict_t* ent);        // Kyper - Discount Arena - get target that is alive
void GetArenaChaseTarget(edict_t* ent);   // Kyper - Discount Arena - get target that is alive
