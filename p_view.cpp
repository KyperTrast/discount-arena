...
void SV_CalcViewOffset(edict_t *ent)
{
	...
	// Kyper - Discount Arena - clear view offsets if chasing someone
	if (ent->client->chase_target)
	{
		ent->client->ps.kick_angles = vec3_t{ 0, 1, 0 };
		ent->client->ps.viewoffset = vec3_t{ 0, 0, (float)ent->viewheight };
		return;
	}
	// Kyper
